...
SET IMAGE_PATH=%DOCKER_IMAGE%
IF DEFINED DOCKER_USER SET IMAGE_PATH=%DOCKER_USER%/%DOCKER_IMAGE%
...
IF DEFINED DOCKER_USER IF NOT "%DOCKER_USER%"=="%DOCKER_USER::=%" SET IMAGE_PREFIX=
IF DEFINED DOCKER_USER IF NOT "%DOCKER_USER%"=="%DOCKER_USER:.=%" SET IMAGE_PREFIX=
IF /I "%DOCKER_USER%"=="localhost" SET IMAGE_PREFIX=
SET IMAGE_NAME=%IMAGE_PREFIX%%IMAGE_PATH%:%DOCKER_TAG%
...
IF "%CONTAINER_NAME%"=="" SET CONTAINER_NAME=iic-osic-tools_shell
